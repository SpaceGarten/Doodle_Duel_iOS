...
let everydayObjects = ["pen", "paper", "book", "table", "chair", "computer", "phone", "keys", "wallet", "watch","computer","mouse","laptop","spider","ant","icecream","pizza","banana","cat","dog","desk","sun","table fan", "clock", "lamp", "bed", "pillow", "blanket", "sofa", "tv", "remote", "car", "bicycle", "bus", "train", "plane", "umbrella", "sunglasses", "shoe", "pants", "shirt", "hat", "coat", "gloves", "scarf", "socks", "toothbrush", "toothpaste", "soap", "shampoo", "conditioner", "razor", "towel", "dish", "silverware", "glass", "plate", "microwave", "fridge", "stove", "oven", "washing machine", "vacuum cleaner", "broom", "dustpan", "trash can", "hanger", "hairbrush", "comb", "scissors", "tape", "glue", "stapler", "paperclip", "binder", "folder", "envelope", "post-it note", "calendar", "whiteboard", "marker", "eraser", "pencil", "ruler", "compass", "protractor", "calculator", "flashlight", "battery", "plunger", "screwdriver", "hammer", "wrench", "tape measure"]
